...
class UbicacionEnfermedadesDB {
  ...
  Future<List?> Ver_Id_UE(String id) async {
    String sql = "";
    sql = "SELECT * FROM tb_ubicación_enfermedades WHERE id_ue =" + id + " ";
  ...
  Future<List?> Listar_UE() async {
    List listaDatos = [];
    String sql =
        "SELECT * FROM tb_ubicación_enfermedades WHERE estado_ue='A' ORDER BY descripcion_ue ASC ";
  ...
  Future<String> Agregar_UE(UbicacionEnfermedades obj) async {
    String sql =
        "INSERT INTO tb_ubicación_enfermedades (id_ue, descripcion_ue, estado_ue) VALUES(NULL, '" +
  ...
  Future<String> Editar_UE(UbicacionEnfermedades obj) async {
    ...
    sql = "UPDATE tb_ubicación_enfermedades SET "
            "descripcion_ue = '" +
        obj.getDescripcion_ue.toString() +
        "', "
            "estado_ue= '" +
