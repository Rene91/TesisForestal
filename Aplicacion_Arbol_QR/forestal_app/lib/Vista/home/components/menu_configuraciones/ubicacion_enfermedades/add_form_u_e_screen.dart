...
class AddFormUbicacionEnfermedadesScreen extends StatefulWidget {
  const AddFormUbicacionEnfermedadesScreen({Key? key}) : super(key: key);

  @override
  _AddFormUbicacionEnfermedadesScreen createState() =>
      _AddFormUbicacionEnfermedadesScreen();
}

class _AddFormUbicacionEnfermedadesScreen
    extends State<AddFormUbicacionEnfermedadesScreen> {
                          ...
                          if (globalFormkey_UbicacionEnfermedades.currentState!
                            ...
                            if (getTextDescricion.text.length > 3) {
                              setState(() async {
                                ...
                                String accion = await objBD.Agregar_UE(obj);
